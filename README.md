...
> AI-powered digital queue management for smarter service delivery with less waiting.
...
- Peak queue size
- Priority traffic ratio
- Skipped / no-show tracking
- Hourly traffic and throughput visualization
- Service-wise demand distribution
- CSV export
- Raw JSON export
